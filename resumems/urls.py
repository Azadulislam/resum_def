...
urlpatterns = [
    ...
    path("profiles/<uuid:pk>/variation/<uuid:variation_id>/edit/", views.profile_variation_edit_view, name="profile-variation-edit"),
    path("profiles/<uuid:pk>/variation/edit/", views.profile_variation_edit_view, name="profile-variation-edit-no-id"),
    path("profiles/<uuid:pk>/variation/<uuid:variation_id>/section/<uuid:section_id>/save-items/", views.profile_variation_save_items, name="profile-variation-save-items"),
